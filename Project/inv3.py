...
while True:
    ...
    portfolio_1_value, data1 = process_messages(day_messages, portfolio_1, portfolio_1_value, investor, 'P31')
    sender(producer, data1)
    portfolio_2_value, data2 = process_messages(day_messages, portfolio_2, portfolio_2_value, investor, 'P32')
